...
export default function Footer() {
  ...
  // All values are deterministic - no window, localStorage, Date.now(), Math.random()
  // The only dynamic value is getFullYear() which is deterministic for the same year
  return (
    <footer className="bg-white dark:bg-black border-t border-gray-200 dark:border-white/10 mt-1 sm:mt-4 transition-colors">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 sm:gap-8">
          ...
          <div className="space-y-4 flex flex-col min-w-0">
            ...
            <div className="flex flex-nowrap gap-3 items-center">
              <a
                href="https://www.facebook.com/barysskylounge/"
                target="_blank"
              ...
              <a
                href="https://x.com/nearbypetcare"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors"
              ...
              <a
                href="https://www.instagram.com/barysskylounge/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors"
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/about" className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors text-sm">
                  About Us
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/affiliate-disclosure" className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors text-sm">
        ...
        {/* Bottom Bar */}
        <div className="mt-4 sm:mt-6 pt-4 sm:pt-6 border-t border-gray-200 dark:border-white/10 flex flex-col justify-center items-center text-center gap-2 transition-colors">
          ...
          <p className="text-gray-500 dark:text-gray-500 text-xs">
            Images and videos used for this website used from <a href="https://www.pexels.com" target="_blank" rel="noopener noreferrer" className="hover:underline">Pexels</a> and <a href="https://www.freepik.com" target="_blank" rel="noopener noreferrer" className="hover:underline">Freepik</a>.
          </p>
        </div>
      </div>
    </footer>
