  ...
  return (
    <footer className="bg-white dark:bg-black border-t border-gray-200 dark:border-white/10 mt-1 sm:mt-4 transition-colors">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 sm:gap-8">
          ...
          <div className="space-y-4 flex flex-col min-w-0">
            ...
            <div className="flex flex-nowrap gap-3 items-center">
              <a 
                href="https://www.facebook.com/nearbypetcare" 
                target="_blank" 
              ...
              <a 
                href="https://www.instagram.com/nearbypetcare/" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors"
              ...
              <a 
                href="https://www.youtube.com/@nearbypetcare" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors"
                aria-label="YouTube"
        ...
        {/* Bottom Bar */}
        <div className="mt-4 sm:mt-6 pt-4 sm:pt-6 border-t border-gray-200 dark:border-white/10 flex flex-col sm:flex-row justify-between items-center transition-colors">
          <p className="text-gray-600 dark:text-gray-400 text-sm transition-colors" suppressHydrationWarning>
