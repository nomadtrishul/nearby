        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              <div className="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-2.5 py-1 rounded-lg font-bold text-base">
                NP
              </div>
              <span className="text-gray-900 dark:text-white font-semibold text-base transition-colors">
                Nearby Pet Care
              </span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-600 dark:text-gray-400 text-sm transition-colors">
              ...
              <li className="flex items-start space-x-2">
                ...
                <span>info@nearbypetcare.com</span>
              </li>
              <li className="flex items-start space-x-2">
                <svg className="w-5 h-5 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
