...
export default function PuppiesKittensSidebar() {
  const guides = [
    { title: 'First 30 Days', href: '/puppies-kittens/first-30-days', icon: '📅' },
    { title: 'Vaccination Timeline', href: '/puppies-kittens/vaccination-timeline', icon: '💉' },
    { title: 'Training Basics', href: '/puppies-kittens/training-basics', icon: '🎓' },
  ];

  return (
    <aside className="w-full lg:w-80 space-y-4 sm:space-y-5">
      {/* Puppies & Kittens Guides Navigation */}
      ...
      <div className="p-3 sm:p-4 bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-white/10 rounded-lg sm:rounded-xl transition-colors">
        ...
        <ul className="space-y-2 sm:space-y-3">
          <li className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">
            <span className="font-semibold text-gray-900 dark:text-white">Establish routines</span> early for feeding, sleep, and potty breaks
          </li>
          <li className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">
            <span className="font-semibold text-gray-900 dark:text-white">Schedule vet visit</span> within the first few days
          </li>
          <li className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">
            <span className="font-semibold text-gray-900 dark:text-white">Start training early</span> with short, positive sessions
          </li>
          <li className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">
            <span className="font-semibold text-gray-900 dark:text-white">Be patient</span> - every pet learns at their own pace
          </li>
        </ul>
      </div>
      ...
      <div className="p-3 sm:p-4 bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/30 rounded-lg sm:rounded-xl backdrop-blur-sm">
        ...
        <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-3 sm:mb-4 transition-colors">
          Always consult with your veterinarian for personalized advice about your puppy or kitten's health and care needs.
        </p>
        <Link
          href="/contact"
