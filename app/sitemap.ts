...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  // Core Category Pillars (priority: 0.9, changefreq: weekly)
  const petNutritionPages: MetadataRoute.Sitemap = [
  ...
  const petHealthPages: MetadataRoute.Sitemap = [
  ...
  const petGroomingPages: MetadataRoute.Sitemap = [
  ...
  const petTrainingPages: MetadataRoute.Sitemap = [
  ...
  const petBreedsPages: MetadataRoute.Sitemap = [
  ...
  const petProductsPages: MetadataRoute.Sitemap = [
  ...
  const puppiesKittensPages: MetadataRoute.Sitemap = [
  ...
  const seniorPetsPages: MetadataRoute.Sitemap = [
  ...
  // Tools & Interactive Pages (priority: 0.8, changefreq: monthly)
  ...
  // Money / Monetization Pages (priority: 0.8, changefreq: weekly)
  const buyingGuidesPages: MetadataRoute.Sitemap = [
  ...
  const comparisonsPages: MetadataRoute.Sitemap = [
  ...
  // Community & Fresh Content (priority: 0.7, changefreq: daily→weekly)
  ...
  const tipPages: MetadataRoute.Sitemap = tips.map((tip) => ({
    url: `${baseUrl}/pet-care-tips/${tip.slug}`,
