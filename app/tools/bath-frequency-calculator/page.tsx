...
const config = {
  ...
  description: 'Calculate the ideal bathing frequency for your pet based on coat type, lifestyle, activity level, and skin condition. Get personalized recommendations for maintaining healthy skin and coat.',
