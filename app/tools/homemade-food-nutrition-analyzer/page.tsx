...
const config = {
  ...
  description: 'Analyze the nutritional content of homemade pet food recipes. Get calorie, protein, fat, carbohydrate, and fiber analysis with recommendations for dogs and cats.',
