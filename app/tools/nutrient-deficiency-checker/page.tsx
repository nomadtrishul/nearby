...
const config = {
  ...
  description: 'Identify potential nutrient deficiencies in your pet based on symptoms. Get information about protein, vitamins, minerals, and fatty acid deficiencies with food sources and recommendations.',
