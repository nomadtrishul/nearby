...
const config = {
  ...
  description: 'Determine if your pet needs multivitamins or specific vitamin supplements based on age, diet type, and health conditions. Get personalized vitamin recommendations with dosage guidance.',
