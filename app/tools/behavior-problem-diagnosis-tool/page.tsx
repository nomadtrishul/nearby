...
const config = {
  ...
  description: 'Identify potential causes of behavior problems in your pet and get guidance on solutions. Diagnose issues like aggression, separation anxiety, house soiling, and more.',
