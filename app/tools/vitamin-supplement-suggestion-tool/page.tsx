...
const config = {
  ...
  description: 'Get personalized vitamin and supplement suggestions for your pet based on age, diet type, and health conditions. Learn about benefits and dosages.',
