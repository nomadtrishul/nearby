...
export default function CatFoodServingSizeCalculatorClient() {
  ...
  const downloadPDF = () => {
    if (!result) return;
    const content = `
Cat Food Serving Size Calculator - NearbyPetCare.com
==================================================
...
Generated by NearbyPetCare.com
    ...
    a.href = url;
    a.download = 'cat-food-serving.txt';
  ...
  const shareOnSocial = (platform: string) => {
    ...
    const shareText = `🐱 My Cat's Daily Food Serving:
    
Calories: ${result.dailyCalories} kcal
Serving: ${result.servingCups} cups
    
Calculate your cat's serving size at nearbypetcare.com!`;
    ...
    switch (platform) {
      ...
      case 'telegram':
        ...
        break;
      case 'linkedin':
        shareUrl = `https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(url)}&title=Cat Food Serving Size&summary=${encodeURIComponent(shareText)}`;
        break;
      case 'copy':
