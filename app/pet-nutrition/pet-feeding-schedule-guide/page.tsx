...
export const metadata: Metadata = {
  ...
  description: 'Learn about ideal feeding schedules for dogs and cats at different life stages. Understand how often to feed puppies, adult pets, and senior pets. Expert recommendations.',
  ...
  alternates: {
    ...
    languages: {
      'en-US': 'https://nearbypetcare.com/pet-nutrition/pet-feeding-schedule-guide',
      'en-GB': 'https://nearbypetcare.com/pet-nutrition/pet-feeding-schedule-guide',
      'en-CA': 'https://nearbypetcare.com/pet-nutrition/pet-feeding-schedule-guide',
      'en-AU': 'https://nearbypetcare.com/pet-nutrition/pet-feeding-schedule-guide',
    },
  },
  robots: {
    index: true,
  ...
  other: {
    ...
    'article:tag': 'pet feeding schedule, meal timing, puppy feeding, senior pet feeding',
  },
};
